      ...
      colors: {
        ...
        vilm: {
          ...
          text: {
            ...
            secondary: "hsl(var(--vilm-text-secondary))",
            tertiary: "hsl(var(--vilm-text-tertiary))",
          },
          border: "hsl(var(--vilm-border))",
          hover: "hsl(var(--vilm-hover))",
          pressed: "hsl(var(--vilm-pressed))",
        },
